...
Invito is a simple and privacy-focused event management platform. It is built with Next.js, Tailwind CSS, Clerk and Stripe.
...
```bash
git clone git@github.com:xanmoy/Invito-web.git
cd your-project
```
